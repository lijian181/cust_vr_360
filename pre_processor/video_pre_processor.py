...
def start_video_line(opt, yml_path='./E3PO/e3po/e3po.yml'):
    for video_path_version in opt['video_path_arr']:
        video_capture = vr_utils.open_video_for_info(video_path_version)
...
if __name__ == '__main__':
    ...
    # 参数增加是否需要dash协议支持
    parser.add_argument('--dash', type=bool, default=False, help='dash protocol support')
    ...
    opt = ff_video_version.create_more_version_videos(opt)
